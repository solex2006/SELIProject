...
import {validateOnlyNumbers, noSpecialCharacters} from '../../../lib/textFieldValidations';
...
export default class AccountManagement extends Component {
        ...
        this.setState({
          ...
          Meteor.call("ValidateEmail", this.state.userInformation.emails[0].address, (error, response) =>  {
            ...
            this.setState({
              ...
              Meteor.call("checkRepeatedEmail", this.state.userInformation._id, this.state.userInformation.emails[0].address, (error, responseR) =>  {
                if (error || responseR) {
                  if (responseR) {
  ...
  finishChangeInformation = () => {
    let userInformation = this.state.userInformation;
    Meteor.call("ChangeAccountInformation", userInformation, this.state.username, (error, response) =>  {
      if (error) {
  ...
  validateAccountInformation = () => {
    ...
    if (!this.state.emailValidated) {
      this.props.handleControlMessage(true, this.props.language.invalidEmail, false, '', '');
      return false;
    }
        ...
        <div className="account-management-form-input-column">
          <div className="form-input-column">
                ...
                <React.Fragment>
                  {
                    ...
                    <div className="form-helper-container">
                      <div className={this.state.validEmail ? "success-helper-text" : "error-helper-text"}>
                        {this.state.emailHelperMessage}
                      </div>
                    </div>
                  }
                  {
            ...
            <TextField
              ...
              label={this.props.language.currentPassword}
              margin="normal"
              variant="outlined"
              type="password"
              fullWidth
              ...
              error={this.state.showError && !this.state.checkCurrentPasswd}
